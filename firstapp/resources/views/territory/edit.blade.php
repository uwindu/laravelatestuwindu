...
<div class="mb-3 row">
    ...
    <div class="col-sm-2">
      <select class="form-select" aria-label="Default select example" name="zone_id">
        ...
        @forelse ($zones as $zone)
            <option value="{{$zone->id}}" @if($territory->zone_id == $zone->id) selected @endif>{{$zone->short_description}}</option>
        @empty
    ...
    <div class="col-sm-2">
      <select class="form-select" aria-label="Default select example" name="region_id">
        ...
        @forelse ($regions as $region)
            <option value="{{$region->id}}"  @if($territory->region_id == $zone->id) selected @endif>{{$region->code}}</option>
        @empty
          <option value="">no options</option>
        @endforelse
      </select>
 ...
 <div class="mb-3 row">
    ...
    <div class="col-sm-3">
      <input type="text"  class="form-control" name="code"  value="{{$territory->code}}">
    </div>
  </div>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-3">
      <input type="text"  class="form-control" name="name"  value="{{$territory->code}}">
    </div>
  </div>
